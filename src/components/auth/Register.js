...
import { FaLock, FaUser, FaRegEnvelope, FaPhone } from "react-icons/fa";
...
import { onboardAgent, onboardCorporate } from "../../services/onboardingService";
...
const Register = () => {
  ...
  const onSubmit = async (values, {resetForm}) => {
    ...
    let res = null
    if(role === "agent") {
       res = (await(onboardAgent(body)))?.data 
    }else{
       res = (await(onboardCorporate(body)))?.data 
    }
              ...
              {errors.name && touched.name && (
                ...
                <div className="account-form-group">
                  ...
                  <input
                    ...
                    id="name"
                    type="name"
                    placeholder={role === "agent" ? "Enter Full Name" : "Enter Company Name"}
                    onBlur={handleBlur}
                    className={
